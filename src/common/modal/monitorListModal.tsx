    ...
    <div className={`modal ${isOpen ? "visible" : "hidden"} w-[550px]  p-4`}>
      <div className=" cursor-pointer">
        ...
        <div className="relative">
          <select
            className={`block cursor-pointer text-14 w-[350px] px-4 py-2 pr-8 text-sm leading-tight bg-white border border-gray-300 rounded-md appearance-none focus:outline-none focus:border-blue-500`}
            onChange={(e) =>
              setFormValues({
                ...formValues,
